...
const DigitalSignature = (props) => {
    ...
    const handleSubmit = () => {
      ...
      setError(false);
      const specimentBase64DataURL = signPadRef.current.getTrimmedCanvas().toDataURL('image/png');
      ...
      // send API
      peruri.signature(dataSignature, token)
      .then(res => {
        console.log(res)
        ...
        )}
        {
          isHandler?.error && (
            ...
            <Alert color="danger my-5">
              ...
              <p>
                {descApi?.error || "Try to reload page and send again."}
              </p>
            </Alert>
            </>
          )
        ...
        {isHandler.success && (
          ...
          {!isHandler.loading && !isHandler.error && (
            ...
            <div className="d-flex w-75 justify-content-center mx-auto my-3">
              ...
              {error &&
              <div className="alert alert-danger my-3">Tanda Tangan tidak boleh kosong</div>
              }
              <div className="text-center">
              <Button color="danger" type="button" onClick={handleClear}>Hapus</Button>
              <Button color="primary" type="button" onClick={handleSubmit}>Kirim</Button>
            </div>
            </>
          )}
      </Container>
